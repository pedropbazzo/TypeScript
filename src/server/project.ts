namespace ts.server {
    ...
    export class ConfiguredProject extends Project {
        ...
        getParsedCommandLine(fileName: string) {
            ...
            const result = this.projectService.parseTsconfigFile(configFileName, canonicalConfigFilePath, this.canonicalConfigFilePath);
            if (this.languageServiceEnabled && this.projectService.serverMode === LanguageServiceMode.Semantic) {
                this.projectService.watchWildcards(configFileName, result, this.canonicalConfigFilePath);
            }
